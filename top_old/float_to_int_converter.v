...
// ============================================================
// File Name: float_to_int_converter.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
module  float_to_int_converter_altbarrel_shift_puf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //float_to_int_converter_altbarrel_shift_puf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float_to_int_converter_altfp_convert_c0n
	( 
	clock,
	dataa,
	result) ;
	...
	float_to_int_converter_altbarrel_shift_puf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //float_to_int_converter_altfp_convert_c0n
//VALID FILE
...
module float_to_int_converter (
	...
	float_to_int_converter_altfp_convert_c0n	float_to_int_converter_altfp_convert_c0n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_to_int_converter.cmp TRUE TRUE
