...
// ============================================================
// File Name: int_to_float_converter.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//VERSION_BEGIN 12.1SP1 cbx_altbarrel_shift 2013:01:31:18:05:07:SJ cbx_altfp_convert 2013:01:31:18:05:07:SJ cbx_altpriority_encoder 2013:01:31:18:05:07:SJ cbx_altsyncram 2013:01:31:18:05:07:SJ cbx_cycloneii 2013:01:31:18:05:07:SJ cbx_lpm_abs 2013:01:31:18:05:07:SJ cbx_lpm_add_sub 2013:01:31:18:05:07:SJ cbx_lpm_compare 2013:01:31:18:05:07:SJ cbx_lpm_decode 2013:01:31:18:05:07:SJ cbx_lpm_divide 2013:01:31:18:05:07:SJ cbx_lpm_mux 2013:01:31:18:05:07:SJ cbx_mgl 2013:01:31:18:08:27:SJ cbx_stratix 2013:01:31:18:05:07:SJ cbx_stratixii 2013:01:31:18:05:07:SJ cbx_stratixiii 2013:01:31:18:05:07:SJ cbx_stratixv 2013:01:31:18:05:07:SJ cbx_util_mgl 2013:01:31:18:05:07:SJ  VERSION_END
...
//VERSION_BEGIN 12.1SP1 cbx_altbarrel_shift 2013:01:31:18:05:07:SJ cbx_mgl 2013:01:31:18:08:27:SJ  VERSION_END

//synthesis_resources = reg 68 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altbarrel_shift_kuf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int_to_float_converter_altbarrel_shift_kuf


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" WIDTH=32 WIDTHAD=5 data q
//VERSION_BEGIN 12.1SP1 cbx_altpriority_encoder 2013:01:31:18:05:07:SJ cbx_mgl 2013:01:31:18:08:27:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //int_to_float_converter_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	int_to_float_converter_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	int_to_float_converter_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //int_to_float_converter_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	int_to_float_converter_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	int_to_float_converter_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //int_to_float_converter_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	int_to_float_converter_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	int_to_float_converter_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //int_to_float_converter_altpriority_encoder_rf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //int_to_float_converter_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	int_to_float_converter_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	int_to_float_converter_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //int_to_float_converter_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	int_to_float_converter_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	int_to_float_converter_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //int_to_float_converter_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	int_to_float_converter_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	int_to_float_converter_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //int_to_float_converter_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	int_to_float_converter_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	int_to_float_converter_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //int_to_float_converter_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_to_float_converter_altfp_convert_c0n
	( 
	clock,
	dataa,
	result) ;
	...
	int_to_float_converter_altbarrel_shift_kuf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	int_to_float_converter_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //int_to_float_converter_altfp_convert_c0n
//VALID FILE
...
module int_to_float_converter (
	...
	int_to_float_converter_altfp_convert_c0n	int_to_float_converter_altfp_convert_c0n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_to_float_converter.cmp TRUE TRUE
